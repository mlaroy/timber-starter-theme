 ...
 */
function mlaroy_custom_login_logo() {
...
add_filter( 'login_head', 'mlaroy_custom_login_logo' );
 ...
 *
 */
function mlaroy_custom_login_url(){
  return get_bloginfo('url');
}

add_filter('login_headerurl', 'mlaroy_custom_login_url');
 ...
 *
 */
function mlaroy_custom_login_title() {
  return get_bloginfo('name');
}

add_filter('login_headertitle', 'mlaroy_custom_login_title');


// Uncomment the following to use custom CSS & JS on the login page
/*
function mlaroy_custom_login_stylesheet() {
    wp_enqueue_style( 'custom-login', get_template_directory_uri() . '/dist/styles/login-page.css' );
}
add_action( 'login_enqueue_scripts', 'mlaroy_custom_login_stylesheet' );
*/
